...
namespace Surbhitest\Biodata\Controller\Adminhtml\Biodata\Image;
...
class Upload extends \Magento\Backend\App\Action
{
    ...
    {
        $imageUploadId = $this->getRequest()->getParam('param_name', 'candidate_image');
        try {
            ...
            $basePath = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'biodata_image/';
            $mediaRootDir = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'biodata_image/';
            ...
            $imageResult['url'] = $mediaUrl . 'biodata_image/'. $newImageName;
        } catch (\Exception $e) {
