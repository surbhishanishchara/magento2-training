...
namespace TrainingSurbhi\Car\Controller\Adminhtml\Car\Image;
...
class Upload extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $basePath = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'car_image/';
            $mediaRootDir = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'car_image/';
